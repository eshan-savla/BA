...
\begin{figure}[h]
	\includegraphics[scale=0.75]{Abbildungen/point_distortion_influence_line.png}
	\centering
...
\begin{figure}[t]
\includegraphics[width=0.9\textwidth]{Abbildungen/point_density_distribution_blech_before.png}
\centering
...
\begin{figure}[t]
	\includegraphics[width=0.9\textwidth]{Abbildungen/point_density_distribution_blech_after.png}
	\centering
